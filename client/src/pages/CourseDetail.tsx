      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-xl overflow-hidden">
            <div className={`${categoryData.iconBgColor} p-8 text-white relative overflow-hidden`}>
            ...
            <div className="p-8">
              ...
              <div className="mb-12">
                <div className="prose max-w-none mb-6">
                  {courseDescriptionData && (
                    <p className="text-lg">{courseDescriptionData.description}</p>
                  )}
                </div>
                
                <h2 className="text-2xl font-bold text-primary-dark mb-6">Course Details</h2>
                ...
                {courseDescriptionData && (
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="includes">
                      ...
                      <AccordionContent>
                        <div className="prose max-w-none">
                          <p>This is a comprehensive certification course (approximately 24.0 hours), which includes all of the following certification components:</p>
                          <ul>
                    ...
                    <AccordionItem value="certification-requirements">
                      <AccordionTrigger className="text-lg font-semibold">
                    ...
                    <AccordionItem value="purchase-includes">
                      <AccordionTrigger className="text-lg font-semibold">
                        Your Purchase Includes
                      </AccordionTrigger>
                      <AccordionContent>
                        <div className="prose max-w-none">
                          <p>All the required Home-Study Course materials for the following components:</p>
                          <ul>
              ...
              <div className="mb-12">
                <h2 className="text-3xl font-bold text-primary-dark text-center mb-8">
                  The {courseData.title} Course<br />
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Button 
                  className="bg-primary hover:bg-primary-dark text-white py-3 px-8 rounded text-lg"
                  onClick={() => setLocation("/pricing")}
                >
                  Get Pricing
                </Button>
                <Button 
                  className="bg-primary-dark hover:bg-primary text-white py-3 px-8 rounded text-lg"
                  onClick={() => setLocation("/contact-register")}
                >
                  Register Now
                </Button>
              </div>
